...
?>
<div class="col-auto p-0 m-0 mr-1 me-1 mb-1 <?php echo esc_attr( $class ); ?>">
	<div class="item-avatar">
		<a href="<?php echo esc_url( GeoDir_Event_AYI::geodir_ayi_get_user_profile_link( $user->ID ) ); ?>" title="<?php echo esc_attr( GeoDir_Event_AYI::geodir_ayi_member_name(GeoDir_Event_AYI::geodir_ayi_get_current_user_name($user))); ?>" data-toggle="tooltip"><?php echo get_avatar($user->ID, 40,'','',array('class'=>'rounded-circle')); ?></a>
	</div>
</div>